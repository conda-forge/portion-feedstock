...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/portion-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10188&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/portion-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `portion` can be installed with:

```
conda install portion
```

It is possible to list all of the versions of `portion` available on your platform with:
